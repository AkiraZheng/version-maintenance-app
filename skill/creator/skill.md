...
- **checklist数据**：按版本ID和日期键存储
  - 每个checklist项：text、notes、completed、completedAt
- **子任务**：嵌套在checklist项下
...
1. **自动备份到log目录**
   ...
   - 文件名格式区分备份类型
   - 命例1：`new-week-backup-2026-03-26-143022.json`（新的一周）
...
```yaml
name: task-tracker
description: 追踪版本维护checklist应用的所有需求和实现细节
